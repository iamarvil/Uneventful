...
public class EventStoreBuilderExtensionCodeGenerator : ISourceGenerator {
    ...
    public void Execute(GeneratorExecutionContext context) {
        ...
        var name = context.Compilation.AssemblyName?.Replace(".", "");
        ...
        foreach (var syntaxTree in syntaxTrees) {
            ...
            foreach (var record in records) {
                ...
                if (parent is ClassDeclarationSyntax syntax) {
                    ...
                    eventTypes.Add($"\t\tbuilder.RegisterEvent<{className}.{recordName}>();");
                    AddNamespace(namespaces, syntax);
                } else {
                    eventTypes.Add($"\t\tbuilder.RegisterEvent<{recordName}>();");
                    if (parent != null) {
        ...
        var source = $$"""
                       ...
                       {{string.Join(Environment.NewLine, eventTypes)}}
        ...
        context.AddSource("EventStoreBuilderExtensions.g.cs", source);
    }
